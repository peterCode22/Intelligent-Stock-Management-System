...
#Export scalers
dump(scalerX, open(os.path.dirname(__file__) + '/Models/scalerX.pkl', 'wb'))
dump(scalerY, open(os.path.dirname(__file__) + '/Models/scalerY.pkl', 'wb'))
...
#Export model
dump(bpnn, open(os.path.dirname(__file__) + '/Models/model.pkl','wb'))
