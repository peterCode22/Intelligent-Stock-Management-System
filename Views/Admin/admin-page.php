...
if($stmt = $mysqli->prepare($predSQL)){
    ...
    if($stmt->execute()){
        ...
        if($result->num_rows == 0){ //Prediction period has passed
            shell_exec('python ../../MachineLearning/predictSales.py');
            $accurate = shell_exec('python ../../MachineLearning/testModel.py');
...
<div style="padding-left:16px">
  ...
  <p>   
		<a href="../../Actions/reset-password.php" class="btn btn-warning">Reset Your Password</a>
        <a href="../../Actions/logout.php" class="btn btn-danger ml-3">Sign Out of Your Account</a>
		</p>
</div>
