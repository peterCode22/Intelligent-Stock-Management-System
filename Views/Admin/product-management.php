                    ...
                    echo '<table class="table table-bordered table-striped">';
                        echo "<thead>";
                              echo '<tr style="background-color:#c9dfca">';
                                    ...
                                    echo '<th>Edit / Delete Product <a href="../../Actions/Admin/create-product.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Product</a> </th>';
                            echo "</tr>";
                        echo "</thead>";
                        echo "<tbody>";
                        while ($row = $result->fetch_array()) {
                            echo '<tr>';
                                ...
                                echo "<td>";
                                    echo '<a href="../../Actions/Admin/update-product.php?id=' . $row['ProdID'] . '" title="Edit Product" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                    echo '  ';
                                    echo '<a href="../../Actions/Admin/delete-product.php?id=' . $row['ProdID'] . '" title="Delete Product" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                echo "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
