                    ...
                    echo '<table class="table table-bordered table-striped">';
                        ...
                        while ($row = $result->fetch_array()) {
                            echo '<tr>';
                                ...
                                echo "<td>";
                                    echo '<a href="../../Actions/Admin/update-batch.php?id=' . $row['BatchID'] . '" title="Change Batch" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                    echo "  ";
                                    echo '<a href="../../Actions/Admin/delete-batch.php?id=' . $row['BatchID'] . '" title="Delete Batch" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                echo "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
